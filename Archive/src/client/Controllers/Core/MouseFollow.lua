-- Timestamp // 10/29/2023 16:51:23 MNT
-- Author // @iohgoodness
-- Description // Mouse follow controller
...
local MouseFollow = Knit.CreateController { Name = "MouseFollow" }

function MouseFollow:KnitStart()
    self.connections = {}
    self.SettingsController = Knit.GetController('Settings')
    repeat task.wait() until self.SettingsController.save
    ...
    RunService.RenderStepped:Connect(function(dt)
        if self.SettingsController.save['Head Turn'] == false then
